...
![EX26b](imgs/c8ex26b.drawio.svg)

因此共轭分拆为 $15 = 5 + 3 + 3 + 2 + 1 + 1$。

### EX26(c)

先画出 Ferrers 图，再画出共轭分拆的图，

![EX26c](imgs/c8ex26c.drawio.svg)

因此共轭分拆为 $20 = 4 + 4 + 4 + 4 + 2 + 2$。

### EX26(d)

先画出 Ferrers 图，再画出共轭分拆的图，

![EX26d](imgs/c8ex26d.drawio.svg)

因此共轭分拆为 $21 = 6 + 5 + 4 + 3 + 2 + 1$。

### EX26(e)

先画出 Ferrers 图，再画出共轭分拆的图，

![EX26e](imgs/c8ex26e.drawio.svg)

因此共轭分拆为 $29 = 6 + 6 + 5 + 4 + 3 + 3 + 1 + 1$。
